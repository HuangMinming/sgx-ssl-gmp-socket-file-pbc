    ...
    uint8_t *TC_DEK_c4_Hex, int TC_DEK_c4_Hex_len)
{
   ...
   */
    ...
    */
   uint8_t pk_Hex[] = {
    
   };
   uint8_t sk_Hex[] = {
    0x06,0x5d,0x10,0x4a,0xbf,0x18,0xdb,0x74,
    0xfa,0xd9,0x2b,0x9f,0xf0,0xfe,0x77,0x85,
    0xee,0x11,0x4e,0x2f
   }
    uint8_t m_bytes[32 + 1];
    memset(m_bytes, 0x00, sizeof(m_bytes));
    int idebug = Dec1(pk_Hex, sizeof(pk_Hex), 
        sk_Hex, sizeof(sk_Hex), 
        TC_DEK_c1_Hex, 256,
        TC_DEK_c2_Hex, 256,
        TC_DEK_c3_Hex, 512,
        TC_DEK_c4_Hex, 256,
