...
// set R fix element
int Enc2_debug(uint8_t *pk_Hex, int pk_Hex_len, 
    uint8_t *m_bytes, int m_bytes_len, 
    uint8_t *w, int w_len, 
    uint8_t *c1_Hex, int c1_Hex_len,
    uint8_t *c2_Hex, int c2_Hex_len,
...
// set s a fix number
int ReKeyGen_debug(uint8_t *pk_j_Hex, int pk_j_Hex_len, 
    uint8_t *sk_i_Hex, int sk_i_Hex_len, 
    uint8_t *pk_i_Hex, int pk_i_Hex_len, 
    uint8_t *w, int w_len,
    uint8_t *rk1_Hex, int rk1_Hex_len,
...
void ReEncTest_2() 
{
    ...
    memcpy(c1_j_Hex, "", G1_ELEMENT_LENGTH_IN_BYTES * 2);
    memcpy(c2_j_Hex, "", GT_ELEMENT_LENGTH_IN_BYTES * 2);
    memcpy(c3_j_Hex, "", SHA256_DIGEST_LENGTH_32 * 8 * 2);
    memcpy(c4_j_Hex, "", G1_ELEMENT_LENGTH_IN_BYTES * 2);
...
int c_pre_main_test() {
    ...
    debug
    */
//    uint8_t *pk_Hex = (uint8_t *)"";
//    uint8_t *sk_Hex = (uint8_t *)"2bc7881c4cd1dd9eaaf79682b41e53c2662e4149";
//    uint8_t *c1_Hex = (uint8_t *)"";
//    uint8_t *c2_Hex = (uint8_t *)"";
//    uint8_t *c3_Hex = (uint8_t *)"";
//    uint8_t *c4_Hex = (uint8_t *)"";
